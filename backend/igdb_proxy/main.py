diff --git a/backend/igdb_proxy/main.py b/backend/igdb_proxy/main.py
new file mode 100644
index 0000000000000000000000000000000000000000..621d18cb71e56e808b9e5962b706e12d5790be66
--- /dev/null
+++ b/backend/igdb_proxy/main.py
@@ -0,0 +1,73 @@
+import json
+import os
...
+	games = _igdb_post(
+		"games",
+		f"search \"{title}\"; fields name, summary, aggregated_rating, first_release_date, involved_companies.company.name, involved_companies.company.url, game_modes.slug, multiplayer_modes; limit 50;"
+	)
+	for game in games:
